// Vercel Serverless Function: Start Live Activity
...
export default async function handler(req, res) {
  ...
  const { activityId, laPushToken, contentState, meta } = req.body;
  ...
  try {
    ...
    if (!response.ok) {
      console.error('[LA/START] OneSignal API error:', result);
